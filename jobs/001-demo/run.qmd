...
This code block usually does not need to be touched. It ensures that 
this notebook can receive the necessary information from the job submit script.
...
JOB_IDENTIFIER = JOB_PATH.name + "-" + str(JOB_ROW) + now
...
handler = logging.FileHandler(filename=DIR_LOG / f"row-{JOB_ROW:04d}.log")
